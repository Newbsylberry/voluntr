...
* Time to install and start redis:
    ...
    tar -zxvf wget-1.15.tar.gz ; cd wget-1.15/ 
    ./configure (if error given then ./configure --with-ssl=openss)
...
We use angular scroll watch  (https://github.com/pc035860/angular-scroll-watch) to handle effects and actions triggered by scrolling.  Here is a gist with an example of how this is used, the repo also has countless examples and information: https://gist.github.com/Newbsylberry/4df0412ea48d637e0a00

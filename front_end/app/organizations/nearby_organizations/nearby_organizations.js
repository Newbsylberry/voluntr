...
angular.module('voluntrApp')
  .controller('NearbyOrganizationsCtrl', function ($scope, $modal, Group, Organization, $stateParams) {
    ...
    var organization_set_up = function(organization) {
      organization.rowspan = randomSpan();
      organization.colspan = randomSpan();
      organization.bg_color = randomColor();
      //var arrays = [organization_ids, organization.opportunity_ids]
      ...
      $scope.nearby_organizations.push(organization)
        // $scope.organization.nearby_organizations.push(organization)
    }
    ...
    $scope.$watch('distance',function(){
      ...
      Organization.nearby_opportunities($stateParams.organization_Id, 'nearby_organizations', $scope.distance).
        $promise.then(function (nearby_orgs) {
          ...
          angular.forEach(nearby_orgs, organization_set_up);

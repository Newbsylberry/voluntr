Rails.application.routes.draw do
  ...
  resources :resource_types, except: [:new, :edit]
  ...
  scope '/api' do
    scope '/v1' do
      ...
      match '/users/reset_password', to: 'users#reset_password', via: :post, defaults: {format: :json}
      match '/users/update_password_reset', to: 'users#update_password_reset', via: :post, defaults: {format: :json}
      ...
      post '/administration/email_volunteers', to: 'administration#email_volunteers', defaults: {format: :json}
      get '/administration/volunteer_drive_leaderboard', to: 'administration#volunteer_drive_leaderboard', defaults: {format: :json}
